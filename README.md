...
2. `config.env` anpassen:
   ...
   **Spezifisch für Freifunk Ingolstadt:**
   - `VPN_TYPES`: Wahl der VPN-Techniken, für die Images gebaut werden sollen. Mögliche Werte siehe https://git.bingo-ev.de/freifunk/ffin-site/blob/master/site.mk
